...
<!-- После добавления PNG в screenshots/ раскомментируй блок:
<p align="center">
...
Экран входа «АПЕКС» · список «Заезды» (трассы, маршалы) · карточка заезда с картой трассы по реальной
geometry (F1 + F2). Файлы — в [`screenshots/`](screenshots/).
