...
<p align="center">
  <img src="karting-apex/screenshots/theme-login.png" alt="Вход «Апекс»" width="30%"/>
  <img src="karting-apex/screenshots/theme-slots.png" alt="Заезды" width="30%"/>
  <img src="karting-apex/screenshots/theme-details.png" alt="Карточка заезда" width="30%"/>
</p>
...
| Своё сверх референса | — | **рекорды круга** (F4) и **паспорт трассы** (F5) |
...
- 🎨 **Гоночная тема** — палитра, типографика и обложки, нарисованные на Canvas.
- 🚀 **Живой деплой** на Render (free tier) — бэкенд, база и веб-клиент.
